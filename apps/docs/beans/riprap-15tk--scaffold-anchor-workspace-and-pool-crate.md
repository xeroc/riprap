...
- `programs/pool` crate `pool`: `anchor-lang = "1.0.2"` + litesvm/solana 3.x dev-deps (ready for riprap-mvoa), empty `#[program]` shell with `declare_id!("PuuLXN4dNzoZ363h93WZi76NHwbH2AZcafKUqjGgdkf")`.
